...
const hollandQuestions = {
  ...
  I: [
    ...
    "Та нарийн төвөгтэй асуудлаар шийдвэрлэлийг олоход сонирхолтой юу?",
...
const mbtiQuestions = {
  ...
  S_N: [
    ...
    {
      text: "Дадлага хийхээр төлөвлөгөө гаргахдаа:",
  ...
  T_F: [
    ...
    },
    {
      ...
      optionA: "Давуу болон сул талаа шууд хэлдэг.",
...
const eqQuestions = [
  ...
  "Хүмүүсийн хооронд зөрчил, маргаан гарахад хурцадмал байдлыг намжаахад би тусалдаг.",
  ...
  "Карьеррийн үзэсгэлэн, оюутны арга хэмжээнд сүлжээ үүсгэж чаддаг.",
  "Шинэ туршилт хийх, эрсдэл хүлээхээс би эмээдэггүй.",
  "Би ихэвчлэн аливаа ажлыг эхлүүлсэн бол заавал дуусгадаг.",
];
...
const TestPage = () => {
  ...
  if (testType === "personality") {
    ...
    currentOptions = ["Зөвшөөрч байна", "Зөвшөөрөхгүй байна"];
  }
