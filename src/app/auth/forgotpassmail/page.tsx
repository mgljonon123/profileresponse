    ...
    <div className="min-h-screen flex">
      ...
      <div className="w-full md:w-1/2 flex flex-col justify-center items-center bg-white p-0">
        <div className="flex flex-col items-center w-full max-w-md">
          ...
          <h2 className="text-3xl font-bold mb-2 text-left w-full">Имэйл илгээгдлээ!</h2>
          ...
          <div className="flex items-center justify-center w-full mb-8">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-24 w-24 text-black" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
          </div>
