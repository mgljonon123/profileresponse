  ...
  const professions = [
    {
      ...
      image: 'https://i.pinimg.com/736x/60/7e/a3/607ea3a0be551f4be2c82e35af3ff007.jpg',
    },
    {
      profession: 'Худалдааны менежер',
      image: 'https://i.pinimg.com/736x/1d/07/92/1d07928ddc507f60bea8d097ab80def0.jpg',
    },
    {
      profession: 'Маркетингийн мэргэжилтэн',
      image: 'https://i.pinimg.com/736x/2b/4e/d6/2b4ed637f66cc7d8df2ff6bba2bcf6a2.jpg',
    },
    {
      profession: 'Санхүүгийн шинжээч',
      image: 'https://i.pinimg.com/736x/3e/28/97/3e2897cd9215be43f51c912e8cf902a8.jpg',
    },
    {
      profession: 'Хүний нөөцийн менежер',
      image: 'https://i.pinimg.com/736x/88/da/ac/88daacb206581851324822d688f75de7.jpg',
    },
    {
      profession: 'Бизнес аналитик',
      image: 'https://i.pinimg.com/736x/96/c1/c9/96c1c9434113dd5a5ab7c004de9fff8f.jpg',
    },
    {
      profession: 'Дижитал маркетолог',
      image: 'https://i.pinimg.com/736x/c6/e0/c6/c6e0c62998bf53d547fb099f6bc831e2.jpg',
    },
    {
      profession: 'UX/UI дизайнер',
      image: 'https://i.pinimg.com/736x/5b/01/3e/5b013e173b8490f4d11881b4fa9fb2a6.jpg',
    },
    {
      profession: 'Харилцаа холбооны мэргэжилтэн',
      image: 'https://i.pinimg.com/736x/e9/0c/5e/e90c5eb1955ad9316f10098a5d920499.jpg',
    },
    {
      profession: 'Борлуулалтын менежер',
      image: 'https://i.pinimg.com/736x/7d/3e/6d/7d3e6d397dbc6cc6ecb71f8839acea41.jpg',
    },
  ];
      ...
      <section className="min-h-screen flex flex-col items-center justify-center relative bg-white px-14 py-10">
        <div className="grid grid-cols-2 gap-8 max-w-5xl w-full">
          {professions.map((item, index) => (
            <AnimatedCard key={index} image={item.image} title={item.profession} />
          ))}
        </div>
