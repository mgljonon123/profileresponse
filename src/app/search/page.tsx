  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#f8fafc] via-[#f1f5f9] to-[#e2e8f0] text-[#222]">
      ...
      <header className="flex items-center justify-between px-8 py-4 border-b border-gray-200 bg-white/80 backdrop-blur-md shadow-sm">
        <Link href="/" className="text-2xl font-bold focus:outline-none text-[#E94A1F]">
        START UP
        </Link>
      ...
      <div className="flex flex-1">
        ...
        <aside className="sticky top-0 h-screen w-[220px] min-w-[200px] max-w-[260px] bg-white/90 border-r border-gray-200 p-6 shadow-sm">
          ...
          <div className="text-sm space-y-4">
            <div>
              <label className="block text-gray-400 font-medium mb-2 text-xs">Хамгийн бага цалин (₮)</label>
              <select
            ...
            <div>
              <label className="block text-gray-400 font-medium mb-2 text-xs">Боловсролын түвшин</label>
              <select
            ...
            <div className="flex items-center gap-2">
              ...
              />
              <label htmlFor="additional-jobs" className="text-gray-400 text-xs">
        ...
        <main className="flex-1 p-8 overflow-y-auto">
          <h1 className="text-2xl font-bold mb-8 text-black">Мэргэжлийн Жагсаалт</h1>
              ...
              {displayedProfessions.map((prof) => (
                ...
                >
                  ...
                  <div className="flex-1">
                    <div className="text-lg font-semibold text-black mb-2 group-hover:text-gray-800">{prof.мэргэжил || 'N/A'}</div>
                    <div className="text-gray-700 text-sm mb-1">№: {prof['№'] ?? 'N/A'}</div>
                    <div className="text-gray-700 text-sm mb-1">Цалингийн хязгаар: {prof.цалингийн_хязгаар?.доод?.toLocaleString() || 'N/A'}₮ - {prof.цалингийн_хязгаар?.дээд?.toLocaleString() || 'N/A'}₮</div>
                    <div className="text-gray-700 text-sm mb-1">Боловсролын түвшин: {getDisplayEducationLevel(prof.боловсролын_түвшин) || 'N/A'}</div>
                    <div className="text-gray-700 text-sm mb-1">IT технологи: {prof.it_технологи !== undefined ? (prof.it_технологи ? 'Тийм' : 'Үгүй') : 'N/A'}</div>
                  </div>
                  <div className="ml-6 text-black text-xl opacity-70 group-hover:opacity-100 transition-opacity duration-200">&rarr;</div>
                </div>
              ))}
            </div>
          )}
